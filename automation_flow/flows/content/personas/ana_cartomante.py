...
- Evitar repetição de temas aleatórios recentes.
- Evitar repetição de falas/contextos muito parecidos com os últimos roteiros.
"""
...
# ── Ajuste automático de diálogo fora da faixa (desativado) ───────────────────
